...
public class WheelView extends View {
     ...
     *///选中颜色
    private int VALUE_TEXT_COLOR = 0xFF0CD3F0;//0xFF666666//0xFF44D997


    /**
     * Items text color
     */
    private int ITEMS_TEXT_COLOR = 0xFF666666;//0xFF666666

    /**
     * Top and bottom shadows colors
     */
    private static final int[] SHADOWS_COLORS = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};
    //private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF,0x00000000, 0x00000000 };

    /**
     * Additional items height (is added to standard text item height)
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 60;//15
     ...
     */
    private static final int ADDITIONAL_ITEMS_SPACE = 2;//2

    /**
     * Label offset ,   dip
     */
    private static int LABEL_OFFSET_DIP = 20;//20
    /**
     * Label offset
     */
    private static int LABEL_OFFSET = 30;//30

    /**
     * Left and right padding value
     */
    private static final int PADDING = 10;//10
    ...
    //最大值，能滚动的最大值 默认-1，不处理
    private int maxScrollValue = -1;
    ...
    private void initData(Context context) {
        ...
        LABEL_OFFSET = dp2px(context, LABEL_OFFSET_DIP);
     ...
     * @param adapter
     */
    private void initMaxScrollValue(WheelAdapter adapter) {
        int count = adapter.getItemsCount() - 1;
        count = count <= 0 ? 0 : count;
        this.maxScrollValue = count;
    }

    /**
     * 设置最大滚动值
     *
     * @param maxScrollValue
     */
    public void setMaxScrollValue(int maxScrollValue) {
        this.maxScrollValue = maxScrollValue;
    }
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        //大于最大滚动值，设置为最大值,<0不处理
        if (maxScrollValue > 0) {
            if (index > maxScrollValue) {
                index = maxScrollValue;
            }
        }
...
//			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        ...
        if (centerDrawable == null) {
            centerDrawable = new ColorDrawable(Color.parseColor("#140CD3F0"));//选中条目颜色
