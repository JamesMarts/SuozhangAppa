package com.yiqi.lottery.common.widget.banner;
...
import com.yiqi.lottery.common.widget.banner.transformer.CoverModeTransformer;
import com.yiqi.lottery.common.widget.banner.transformer.ScaleYTransformer;
...
public class BannerView<T> extends RelativeLayout {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link BannerView {@link #setPages(List, HolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start() {
     ...
     * @param mzHolderCreator ViewHolder生成器 {@link HolderCreator} And {@link ViewHolder}
     */
    public void setPages(List<T> datas, HolderCreator mzHolderCreator) {
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        private List<T> mDatas;
        private HolderCreator mMZHolderCreator;
        private ViewPager mViewPager;
        private boolean canLoop;
        private BannerPageClickListener mPageClickListener;
        private final int mLooperCountFactor = 500;

        public MZPagerAdapter(List<T> datas, HolderCreator MZHolderCreator, boolean canLoop) {
            if (mDatas == null) {
        ...
        private View getView(int position, ViewGroup container) {
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    com.suozhang.framework.utils.T.showShort("click!");
