...
public class BetterDoubleGridView extends LinearLayout implements View.OnClickListener {
    ...
    private List<FilterBaseBo> mTopGridData;
    private List<FilterBaseBo> mBottomGridList;
    ...
    public BetterDoubleGridView setmTopGridData(List<FilterBaseBo> mTopGridData) {
        this.mTopGridData = mTopGridData;
        return this;
    }

    public BetterDoubleGridView setmBottomGridList(List<FilterBaseBo> mBottomGridList) {
    ...
    public void clickDone() {
        ...
        if (mTopSelectedTextView != null) {
                FilterUrl.instance().doubleGridTop = (FilterBaseBo) (mTopSelectedTextView == null ? "" : mTopSelectedTextView.getTag());

        }
        if (mBottomSelectedTextView != null) {
                FilterUrl.instance().doubleGridBottom = (FilterBaseBo) (mBottomSelectedTextView == null ? "" : mBottomSelectedTextView.getTag());
        }
